...
![deformable-component-manipulation](./images/deformable-component-assembly.png "Robotic manipulation of deformable parts")
...
We'll use `/ianvs` as the workspace:
```bash
...
![F1-Confidence Curve](images/F1-confidence_curve.png)
*Optimal F1-score achieved at confidence threshold of ~0.5*

#### Precision vs Confidence
![Precision-Confidence Curve](images/precision-confidence_curve.png)
...
![Recall-Confidence Curve](images/recall-confidence_curve.png)
*Recall performance across different detection thresholds*

#### Label Distribution
![Labels Distribution](images/labels.png)
*Distribution of component classes across the training dataset*

#### Label Correlation Matrix
![Label Correlations](images/labels_correlate.png)
...
![YOLO Predictions - Sample 1](images/yolo_predictions.png)
![YOLO Predictions - Sample 2](images/yolo_predictions2.png)
![YOLO Predictions - Sample 3](images/yolo_predictions3.png)
...
[Industrial Embodied Intelligence Dataset(CNCF'LFX 25@kubeedge8739 )Project Explanation](https://www.youtube.com/watch?v=your-video-link)
...
`KubeEdge` `Ianvs` `Embodied Intelligence` `Industrial Manufacturing` `Robotic Assembly` `Force Control` `Computer Vision` `YOLOv8` `Edge AI` `Benchmarking`