...
draft: false
lastmod: 2025-06-18
summary: KubeEdge v1.21 is live!
tags:
- KubeEdge
- kubeedge
- edge computing
...
- [New Generation Node Task API and Implementation](#new-generation-node-task-api-and-implementation)
- [Support Closed Loop Flow Control](#support-closed-loop-flow-control)
- [Support Update Edge Configuration from Cloud](#support-update-edge-configuration-from-cloud)
- [Support One-Click Deployment of Dashboard and Integration of kubeedge/keink](#support-one-click-deployment-of-dashboard-and-integration-of-kubeedgekeink)
