...
5. Also, check that the `podSandboxImage` is correctly set as defined in [Modification in edgecore.yaml](../configuration/config#修改-edgecoreyaml).
...
You can also enable `kubectl logs` feature refer to this [guide](./debug.md).